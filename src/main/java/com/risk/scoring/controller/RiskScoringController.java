...
public class RiskScoringController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Risk score calculated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RiskCalculationResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid request data provided") })
    public ResponseEntity<RiskCalculationResponse> calculateRiskScore(
            @Valid @RequestBody RiskCalculationRequest request) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Customer risk profile retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerRiskProfileResponse.class))),
            @ApiResponse(responseCode = "404", description = "Customer not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<CustomerRiskProfileResponse> getCustomerRiskProfile(
            @Parameter(description = "ID of the customer", required = true) @PathVariable String customerId) {
        try {
            CustomerRiskProfileResponse response = customerRiskProfileService
                    .getCustomerRiskProfileResponse(customerId);
            if (response != null) {
                return ResponseEntity.ok(response);
            } else {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Risk rule created/updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RiskRuleResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid request data provided"),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<RiskRuleResponse> createOrUpdateRule(
            @Parameter(description = "Risk rule request object", required = true) @Valid @RequestBody RiskRuleRequest request) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Risk rule activated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RiskRuleResponse.class))),
            @ApiResponse(responseCode = "404", description = "Risk rule not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<RiskRuleResponse> activateRule(
            @Parameter(description = "ID of the risk rule to activate", required = true) @PathVariable String ruleId) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Risk rule deactivated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RiskRuleResponse.class))),
            @ApiResponse(responseCode = "404", description = "Risk rule not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<RiskRuleResponse> deactivateRule(
            @Parameter(description = "ID of the risk rule to deactivate", required = true) @PathVariable String ruleId) {
        try {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Risk rule deleted successfully"),
            @ApiResponse(responseCode = "404", description = "Risk rule not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<Void> deleteRule(
            @Parameter(description = "ID of the risk rule to delete", required = true) @PathVariable String ruleId) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Anomalies retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AnomaliesResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Customer risk trend retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerProfileSummary.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<List<CustomerProfileSummary>> getCustomerRiskTrend(
            @Parameter(description = "ID of the customer", required = true) @PathVariable String customerId,
            @Parameter(description = "Number of days to retrieve trend for", example = "30") @RequestParam(defaultValue = "30") int days) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Anomalies retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Anomaly.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<List<Anomaly>> getAnomaliesByCustomerId(
            @Parameter(description = "ID of the customer", required = true) @PathVariable String customerId) {
        try {
    ...
    public ResponseEntity<List<Anomaly>> getAnomaliesByType(
            @Parameter(description = "Type of anomaly to retrieve", required = true) @PathVariable String anomalyType) {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Anomalies retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Anomaly.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error") })
    public ResponseEntity<List<Anomaly>> getAnomaliesBySeverity(
            @Parameter(description = "Severity level of anomalies to retrieve", required = true) @PathVariable String severity) {
        try {
